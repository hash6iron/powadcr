...
// --------------------------------------------------------------
#define VERSION "1.0r7.15p11" // Formato: vX.YrW.Z (X=major, Y=minor, W=revision, Z=revision_minor)
...
// --------------------------------------------------------------
// Tarea del Core 0 - Tape control (Task1code - tapeControl, audio, etc.) - La
// más pesada
...
#define CONFIG_MBEDTLS_ASYMMETRIC_CONTENT_LEN                                  \
  1                                            // Habilitar contenido asimétrico
...
#define CONFIG_MBEDTLS_CERTIFICATE_BUNDLE                                      \
  0                                       // Deshabilitar bundle de certificados
...
// Browser
// --------------------------------------------------------------
#define TOTAL_FILES_IN_BROWSER_PAGE                                            \
  13                         // No se cuenta la primera fila que es para el path
...
#define EACH_FILES_REFRESH                                                     \
  5 // Cada n ficheros refresca el marcador. Por defecto 50
...
#define RADIO_MIN_BUFFER_FILL                                                  \
  (16 * 1024) // 16KB antes de empezar (más conservador)

// ✅ INTERVALOS MÁS AGRESIVOS PARA CONEXIONES PROBLEMÁTICAS
#define RADIO_NETWORK_READ_INTERVAL 2 // 5ms (más frecuente que 8ms)
#define RADIO_PLAYBACK_INTERVAL                                                \
  10 // 8ms (menos frecuente para conservar buffer)
...
//
// -------------------------------
// Dejar todo esto tal como está. La configuración se hace en el fichero
// wifi.cfg
//
