...
<p align="center">
  <img src="doc/images/powadcr_banner.png" width="700">
</p>

<p align="center">
  <strong>TAP/TZX/TSX/CDT Digital Cassette Recorder for 8-bit Computers</strong><br>
  WAV/MP3 Player & Recorder based on ESP32 Audio Kit
</p>

<p align="center">
  <img src="https://img.shields.io/github/license/hash6iron/powadcr">
  <img src="https://img.shields.io/github/stars/hash6iron/powadcr">
  <img src="https://img.shields.io/github/issues/hash6iron/powadcr">
  <img src="https://img.shields.io/github/repo-size/hash6iron/powadcr">
</p>
...
POWADCR is a digital cassette recorder emulator designed for retro 8-bit computers such as:
...
- WAV recording/playback
- MP3 audio playback
- Touchscreen HMI interface
- SD card support
- Portable battery-powered operation

The project combines retro-computing authenticity with modern embedded hardware.
...
- 🔊 ES8388 HiFi audio codec
- 📡 WiFi & Bluetooth capable hardware
- 💽 SD card file browser
- 🔋 Optional battery support
- 🕹 Compatible with modern and classic 8-bit systems
...
> [!NOTE]
> T0 displays are used in this project, although T1 versions can be adapted easily.
...
| 3.5" TJC TFT Display | Resistive or capacitive |
...
<p align="center">
  <img src="doc/images/lcd_connection.jpg" width="600">
</p>
...
> [!WARNING]
> Verify power polarity before powering the display.
...
<p align="center">
  <img src="doc/images/powadcr_front.jpg" width="400">
  <img src="doc/images/powadcr_inside.jpg" width="400">
</p>
