...
class TAPproccesor
{
    public:
      ...
      int getBlockDescriptor(File32 mFile, int sizeTAP)
      {
              ...
              if (blockChk == chk)
              {
                  ...
                  if (flagByte == 0)
                  {
                      ...
                      if (typeBlock==0)
                      {
                          ...
                          bDscr[numBlocks].name = (String(getBlockName(readFileRange32(mFile,startBlock,19,false),0))).substring(0,9);
                          state = 1;
                      }
                      else if (typeBlock==1)
                      {
    ...
    private:
      ...
      TAPproccesor(File32 mFile, int sizeTAP)
      {
          ...
          totalBlocks = getBlockDescriptor(mFile, sizeTAP);
